...
globalkeys = my_table.join(
    -- Take a screenshot
    awful.key({ }, "Print", function () awful.util.spawn(string.format("flameshot full -p %s/Pictures", os.getenv("HOME")), false) end),
    awful.key({ modKey }, "Print", function () awful.util.spawn(string.format("flameshot gui -p %s/Pictures", os.getenv("HOME")), false) end),
    ...
    awful.key({ }, "XF86AudioRaiseVolume",
        function ()
            os.execute("~/.config/i3/vctl.sh -i 5")
            beautiful.volume.update()
        end,
        {description = "volume up", group = "hotkeys"}),
    awful.key({ }, "XF86AudioLowerVolume",
        function ()
            os.execute("~/.config/i3/vctl.sh -d 5")
            beautiful.volume.update()
        end,
        {description = "volume down", group = "hotkeys"}),
    awful.key({ }, "XF86AudioMute",
        function ()
            os.execute("~/.config/i3/vctl.sh -t")
            beautiful.volume.update()
        end,
